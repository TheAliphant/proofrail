...
## Status
Early public MVP. The receipt core is intentionally chain-agnostic. Base/x402, Filecoin archival and Stellar settlement adapters are planned as separate modules.
